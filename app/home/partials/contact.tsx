    ...
    >
      <div className='container flex flex-col items-start justify-between gap-12 md:flex-row'>
        ...
        <div className='flex flex-1 flex-col items-center md:items-start'>
          <div className='relative aspect-3/4 w-full flex-1 overflow-hidden md:w-fit'>
            ...
            <Image
              ...
              width={420}
              height={640}
              className='-rotate-[1.45deg] object-cover opacity-40 mix-blend-luminosity will-change-transform'
            />
